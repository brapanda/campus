<template>
    <view>
        <view class="list-cell" hover-class="uni-list-cell-hover" @click="bindClick">
            <view class="media-list" v-if="data.address">
                <view :class="[isImgRight?'media-image-right':'',isImgLeft?'media-image-left':'']">
                    <text :class="['media-title',isImgRight||isImgLeft?'media-title2':'']">{{data.address}}</text>
                ...
                <view class="media-foot">
                    <view class="media-info m-row m-flex-item">
                        <text class="info-text">MLS#: {{data.mlsid}}</text>
                        <view class="info-text m-flex-item" v-if="isPaid">已支付</view>
						<view class="info-text m-flex-item" v-else>未支付</view>
