		...
		<form @submit="formSubmit" @reset="formReset">
			...
			<view class="cu-list menu margin-top" :class="[true?'card-menu':'']" style="background: white;">
				<view class="uni-list-item__container">
					<view class="uni-list-item__content-title" @click="searchSchool">
						学校
					</view>
					...
					<view class="uni-list-item__content item-font">
						<view style="text-align:right" name="schoolID" id="schoolID" @click="searchSchool">
							{{initalData.school.name}}
						</view>
					</view>
				</view>
			...
			<view class="cu-bar bg-white solid-bottom margin-top">
				<view class="action">
					<view class="cuIcon-title" style="font-weight: 700;">学生信息 (以学校登记信息为准)</view>
					<!-- <view class="uni-list-item__content item-font" style="font-weight: 400;font-size: ">应与学校录取通知书一致</view> -->
				</view>
			</view>
			<view class="cu-list menu margin-top" :class="[true?'card-menu':'']" style="background: white;">
				<view class="uni-list-item__container">
					...
					<view class="uni-list-item__content item-font">
						<input style="text-align:right" name="studentLastName" placeholder="姓(拼音)" id="studentLastName" @input="inputInfo" :value="initalData.studentLastName" />
					</view>
					<view class="uni-list-item__content item-font">
						<input style="text-align:right" name="studentFirstName" placeholder="名(拼音)" id="studentFirstName" @input="inputInfo" :value="initalData.studentFirstName" />
					</view>
				</view>
				...
				<view class="uni-list-item__container">
					...
					<view class="uni-list-item__content item-font">
						<input style="text-align:right" name="studentIDConfirm" placeholder="确认学生号" id="studentIDConfirm" @input="inputInfo" :value="initalData.studentIDConfirm" />
					</view>
				</view>
			...
			<view class="cu-bar bg-white solid-bottom margin-top">
				<view class="action">
					<view class="cuIcon-title" style="font-weight: 700;">付款人信息</view>
				</view>
			</view>
			<view class="cu-list menu margin-top" :class="[true?'card-menu':'']" style="background: white;">
				<view class="uni-list-item__container">
					...
					<view class="uni-list-item__content item-font">
						<input style="text-align:right" name="payerLastName" placeholder="姓(拼音)" id="payerLastName" @input="inputInfo" :value="initalData.payerLastName" />
					</view>
					<view class="uni-list-item__content item-font">
						<input style="text-align:right" name="payerFirstName" placeholder="名(拼音)" id="payerFirstName" @input="inputInfo" :value="initalData.payerFirstName" />
					</view>
				</view>
				<view class="uni-list-item__container">
					<view class="uni-list-item__content-title">
					...
					<view class="uni-list-item__content item-font">
						<input style="text-align:right" name="payerPhone" placeholder="电话" id="payerPhone" @input="inputInfo" :value="initalData.payerPhone" />
					</view>
				</view>
				<view class="uni-list-item__container">
					<view class="uni-list-item__content-title">
					...
					<view class="uni-list-item__content item-font">
						<input style="text-align:right" name="payerEmail" placeholder="邮箱" id="payerEmail" @input="inputInfo" :value="initalData.payerEmail" />
					</view>
				</view>
			</view>
...
<script>
	...
	export default {
		...
		methods:{
			...
			searchSchool(){
				uni.navigateTo({
					url:'/components/chose-city/chose-city'
				})
			},
			saveInfo(){
				uni.setStorageSync("schoolPayment",this.initalData)
			},
			getMpConfig(){
				var _this = this;
				//获取微信公众号配置
			...
			formSubmit(e){
				...
				var _this = this;
				if(_this.initalData.school.name == "请选择教育机构"){
					showMsgBox("请选择学校");
					return;
				}
				if(!_this.initalData.studentLastName || !_this.initalData.studentFirstName){
					showMsgBox("请填写学生姓名");
					return;
				}
				...
				if (_this.initalData.studentID != _this.initalData.studentIDConfirm){
					showMsgBox("学生号不一致");
					return;
				}
				if(!_this.initalData.payerLastName || !_this.initalData.payerFirstName){
					showMsgBox("请填写付款人姓名");
					return;
				}
				if(!_this.initalData.payerPhone || !_this.initalData.payerEmail){
					showMsgBox("请填写联系方式");
					return;
				}
				...
				try{
					uni.uploadFile({
						...
						name: "Attach",
						formData:{
							"HouseId": _this.initalData.school.name,//学校名字
							"CName":_this.initalData.studentLastName + ',' + _this.initalData.studentFirstName,//学生姓名
							"Id":_this.initalData.school.studentID,//学生号
							"Agent": _this.initalData.payerLastName + ',' + _this.initalData.payerFirstName,//付款人姓名
							"Tel":_this.initalData.payerPhone,//付款人电话
							"Address":_this.initalData.payerEmail,//付款人Email
							"CTel": "",//
			...
			inputInfo(e){
				...
				switch (id){
					...
					case "studentLastName":
						this.initalData.studentLastName = value
						break
					case "studentFirstName":
						this.initalData.studentFirstName = value
						break
					case "studentID":
						this.initalData.studentID = value
						break
					case "studentIDConfirm":
						this.initalData.studentIDConfirm = value
						break
					case "payerLastName":
						this.initalData.payerLastName = value
						break
					case "payerFirstName":
						this.initalData.payerFirstName = value
						break
					case "payerPhone":
						this.initalData.payerPhone = value
						break
					case "payerEmail":
						this.initalData.payerEmail = value
						break
					case "desc":
		...
		onShow() {
			var school = uni.getStorageSync("myCityObj")
			console.log("school",school)
			if (school && school != {}){
				this.initalData.school = school
			}
		},
		onLoad(e) {
			// if(!this.hasLogin){
			...
			var saveinfo = uni.getStorageSync("schoolPayment")
			if (saveinfo){
				_this.initalData = saveinfo
			}
		}
	}
</script>
